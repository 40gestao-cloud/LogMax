    ...
    projects: [
      {
        test: {
          name: 'estatico',
          include: ['tests/rotas.test.ts', 'tests/aulaFluxos.test.ts', 'tests/aulaPapel.test.ts', 'tests/confirm.test.ts'],
        },
      },
      {
        test: {
          ...
          exclude: ['tests/rotas.test.ts', 'tests/aulaFluxos.test.ts', 'tests/aulaPapel.test.ts', 'tests/confirm.test.ts'],
