...
export const AULA_SUBMENUS: Record<string, string[]> = {
  ...
  rh:         ['Funcionários', 'Departamentos', 'Cargos', 'Registro de Ponto', 'Férias', 'Afastamentos', 'Desligamento', 'Recrutamento e Seleção', 'Folha de Pagamento', 'Remuneração Variável', 'Benefícios', 'Treinamentos', 'Pesquisas', 'Gerenciamento', 'Relatórios'],
