...
export const AULA_MODULOS: AulaModuloDef[] = [
  ...
  { id: 'politicas',         label: 'Políticas',        grupo: 'Geral' },
...
export const AULA_SUBMENUS: Record<string, string[]> = {
  ...
  rh:         ['Funcionários', 'Departamentos', 'Cargos', 'Registro de Ponto', 'Férias', 'Afastamentos', 'Desligamento', 'Recrutamento e Seleção', 'Folha de Pagamento', 'Remuneração Variável', 'Mandatos', 'Benefícios', 'Treinamentos', 'Pesquisas', 'Gerenciamento', 'Relatórios'],
