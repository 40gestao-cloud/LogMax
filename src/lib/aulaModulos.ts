...
export const AULA_SUBMENUS: Record<string, string[]> = {
  ...
  financeiro: ['Controle de Caixa', 'Contas a receber', 'Contas a pagar', 'Caixa / Bancos', 'Patrimônio', 'Centros de Custo', 'Orçamento Anual', 'Prestação de Contas', 'DRE', 'Juros & Multa', 'Alçadas', 'Notas Emitidas', 'Aprovações de Cotação', 'Aprovações de Orçamento', 'Aprovações de Promoções', 'Aprovações de Conteúdo', 'Pedidos de Venda', 'Recibos de Vendas', 'Capital', 'Destinação do Resultado', 'Gerenciamento', 'Relatórios'],
