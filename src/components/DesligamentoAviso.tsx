        ...
        >
          ...
          >
            ...
            <div className="flex flex-col sm:flex-row gap-2 justify-center mt-6">
              ...
              {/* `scope: 'local'` pela mesma razão de `useAuth.signOut` — sair
                  daqui não derruba a sessão do mesmo usuário em outra máquina. */}
              <button
                onClick={() => { void import('../lib/supabase').then(m => m.supabase?.auth.signOut({ scope: 'local' })); }}
