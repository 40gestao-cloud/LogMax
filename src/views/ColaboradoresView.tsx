  ...
  return (
    <motion.div initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }} className="flex flex-col h-full gap-8">
      <div className="flex justify-between items-center shrink-0">
        <div>
          <h2 className="text-3xl font-bold text-gray-100 tracking-tight">Gestão de Colaboradores</h2>
          <p className="text-sm text-gray-400 mt-1">Gerencie sua equipe, cargos e permissões de acesso.</p>
        </div>
        <div className="flex gap-4 items-center">
          <div className="relative">
            <Search size={16} className="absolute left-3 top-1/2 -translate-y-1/2 text-gray-500" />
            <input type="text" placeholder="Buscar colaborador..." className="neu-input py-2.5 pl-10 pr-4 rounded-xl text-sm w-64"
