  ...
  return (
    <motion.div initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }} className="flex flex-col h-full gap-8">
      <div className="flex justify-between items-center shrink-0">
        <div><h2 className="text-3xl font-bold text-gray-100 tracking-tight">Previsão de Vencimentos</h2><p className="text-sm text-gray-400 mt-1">Controle de lotes com vencimento próximo ou vencidos.</p></div>
