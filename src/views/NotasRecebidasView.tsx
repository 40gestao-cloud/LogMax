  ...
  return (
    <motion.div initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }} className="flex flex-col h-full gap-8">
      <div className="flex flex-wrap justify-between items-start gap-3 shrink-0">
        <div><h2 className="text-2xl sm:text-3xl font-bold text-gray-100 tracking-tight">Notas Recebidas</h2><p className="text-sm text-gray-400 mt-1">Gerencie as notas fiscais recebidas de fornecedores.</p></div>
